...
4. If the change touched documentation, also run the equivalent doc-link validation described in `.claude/hooks/doc_link_check.py` or `.junie/skills/link-check/SKILL.md`.
Treat `$prompt` as an optional scope hint or WIP explanation.
