...
description: >-
  Use this agent after `awesome-templates generate` has produced a target
  project's `.claude/` kit. It researches the target project and resolves its
  `TEMPLATE-INIT` markers with concrete, project-specific prose.
