...
4. **Project conventions**: check against the full standard, not just the container doc - `@docs/dev/java_android_coding_standard.md` for the project-specific overrides and Android/Java style, including Javadoc on changed public APIs, nullability conventions, Gradle/lint cleanliness, naming, and component boundaries.
