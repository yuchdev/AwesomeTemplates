...
3. For each hit, report `file:line: <type>`. Never print secret values or line
...
- [ ] Each finding reported as `file:line: <type>` - no secret value or source-line excerpt printed
