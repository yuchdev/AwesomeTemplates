...
- `agent:core/subtask-verifier`
- `agent:java/testing-expert`
- `agent:python/app-architect`
- `agent:python/docs-updater`
...
- `hook:python/style_fixes`
- `skill:core/link-check`
- `skill:core/pr-review`
- `skill:core/secret-scan`
- `skill:verify-subtask`
- `skill:python/dep-audit`
- `skill:python/test-gap`
