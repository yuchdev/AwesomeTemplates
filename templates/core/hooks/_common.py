"""Shared helpers for {{PROJECT_NAME}} Claude Code hooks.
...
# ---------------------------------------------------------------------------
# Shared doc-corpus helpers - used by doc_link_check.py, doc_registry.py, and
# linkify_doc_mentions.py so the heading-slug and link-scan logic lives in one
