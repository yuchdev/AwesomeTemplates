...
7. **Elevation**: can an automated remediation/action proceed without explicit authorization? Is the `{{PROJECT_SLUG_UPPER}}_PROD_CONFIRMED` guard (or your project's equivalent) respected?
