...
<!-- TEMPLATE-INIT: Identify any project-specific categories of sensitive data this codebase handles beyond generic request/response payloads (e.g. specific file types, domain records, or artifacts it processes) and name them here. -->
