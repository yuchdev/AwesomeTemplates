...
| 0001 | Alternative headless harness support (`copilot`, `junie` alongside `claude`; credential flags, `--backend` removal) - ✅ complete 2026-09-08 | [plan.md](/docs/roadmap/0001-alternative-harness-support/plan.md) | [status.md](/docs/roadmap/0001-alternative-harness-support/status.md) |
